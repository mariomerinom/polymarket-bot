...
> **Tracking:** These recommendations are tracked with automated triggers in [`docs/core/decisions.md`](../core/decisions.md). The daily report alerts when conditions are met.
